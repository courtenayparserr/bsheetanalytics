				...
				if (!filtered || v[i]->accum.seconds) {
					...
					if (_MSG.length() == 0)
					{
						if (wcscmp(uexename, U("null")) == 0)
							_MSG = utility::string_t(U("[{ \"url\":\"")) + utility::string_t(uurl) + utility::string_t(U("\",\"app\" : ")) + utility::string_t(U("null")) + utility::string_t(U(",\"computername\" : \"")) + utility::string_t(GetWC(computerNode.c_str())) + utility::string_t(U(",\"email\" : \"")) + utility::string_t(GetWC(emailNode.c_str())) + utility::string_t(U("\",\"dbId\" : \"")) + utility::string_t(GetWC(userNode.c_str())) + utility::string_t(U("\",\"seconds\" : ")) + utility::string_t(szElapsedTime) + utility::string_t(U(",\"date\" : \"")) + utility::string_t(szDate) + utility::string_t(U("\" }"));
						else
							_MSG = utility::string_t(U("[{ \"url\":\"")) + utility::string_t(uurl) + utility::string_t(U("\",\"app\" : \"")) + utility::string_t(uexename) + utility::string_t(U("\",\"computername\" : \"")) + utility::string_t(GetWC(computerNode.c_str())) + utility::string_t(U("\",\"email\" : \"")) + utility::string_t(GetWC(emailNode.c_str())) + utility::string_t(U("\",\"dbId\" : \"")) + utility::string_t(GetWC(userNode.c_str())) + utility::string_t(U("\",\"seconds\" : ")) + utility::string_t(szElapsedTime) + utility::string_t(U(",\"date\" : \"")) + utility::string_t(szDate) + utility::string_t(U("\" }"));
